...
См. [LOCAL_SETUP.md](./LOCAL_SETUP.md) для подробных инструкций по локальной настройке.
...
**ВАЖНО**: Это хобби-проект, который не претендует на стабильность. Используйте на свой страх и риск. Автор не несет ответственности за любые финансовые потери или проблемы, связанные с использованием данного узла.
...
Вклад приветствуется! См. [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md) для правил поведения.
...
- **Автор**: [Укажите контактную информацию]
- **Issues**: [GitHub Issues](https://github.com/yourusername/n8n-nodes-telegram-stars/issues)
